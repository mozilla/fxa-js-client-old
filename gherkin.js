...
var Token = require('./lib/models/token')(inherits, Bundle)
var tokens = {
  AccountResetToken: require('./lib/models/account_reset_token')(inherits, Token, crypto),
  KeyFetchToken: require('./lib/models/key_fetch_token')(inherits, Token),
  SessionToken: require('./lib/models/session_token')(inherits, Token)
}
var AuthBundle = require('./lib/models/auth_bundle')(inherits, Bundle, null, tokens)
